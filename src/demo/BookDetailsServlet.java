...
public class BookDetailsServlet extends HttpServlet {
    ...
    private String getContent() {
        ...
        buffer.append("<h2>Web components for developers</h2>&nbsp; by<em> Java Expert</em> &nbsp; &nbsp; (2015)<br> &nbsp; <br><h4>Here's what the critcs say: </h4><blockquote>Web components for developers talks about how web components can transfor the way you develop application for the web</blockquote><h4>Our Price: 5.9</h4><p><strong><a href=\"/bookcatalog?bookId=203\">Add to Cart</a>&nbsp;&nbsp;&nbsp;<a href=\"/bookcatalog\">Continue Shopping</a></p></strong> ");
